...
$check_available=0;
$check_available=check_duplicate_product($company_name,$product_name,$packing_size);
$available_qty=0;
$check_the_qty=0;

if ($check_available==0)
{
$available_qty=check_qty($product_company,$product_name,$packing_size,$link);
if($available_qty>=$qty)
{
    $b=array("company_name"=>$company_name, "product_name"=>$product_name,"packing_size"=>$packing_size,"price"=>$price,"qty"=>$qty); 
...
else
{
    ...
    $av_qty=0;
    $exist_qty=0;
    $exist_qty=check_the_qty($company_name,$product_name,$packing_size);
...
{
    $product_qty=0; 
    $res=mysqli_query($link,"select  * from stock_master where product_company='$product_company' && product_name='$product_name' && packing_size='$packing_size'");
